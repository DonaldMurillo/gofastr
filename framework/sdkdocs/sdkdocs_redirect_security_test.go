...
// tier T2):
// every DecisionRedirect URL is scrubbed of C0/DEL bytes before
...
// uihost sibling pins.
// Fix: d.URL is scrubbed at the emit site with textsafe.StripUnsafe
// (the shared C0/DEL/C1/invisible scrub), keeping the visible path
// intact; the control leg pins that clean URLs round-trip byte-identical.
