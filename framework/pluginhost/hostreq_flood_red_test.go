...
// CONTRACT-QUESTION red: the broker file header claims the request contract
// is bounded "both directions" (MAX_INFLIGHT as the pending-request bound) —
// this asserts the inbound frame→host direction is bounded too; if "both
// directions" was meant to describe only the pending maps, fix the header
// comment and delete this.
//
