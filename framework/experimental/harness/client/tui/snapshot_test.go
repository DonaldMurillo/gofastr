...
//   GOFASTR_UPDATE_SNAPSHOTS=1 go test ./framework/experimental/harness/client/tui/ -run TestSnapshot
...
import (
	...
	harnessTool "github.com/DonaldMurillo/gofastr/framework/experimental/harness/tool"
