...
// Pins: external/model-borne text is C0/DEL/CSI/OSC-sanitized before reaching the terminal.
...
// Pins: terminal-bound output must not carry content-borne terminal
