...
//
//   go test -tags=e2e_real -v -run E2EExternal ./framework/experimental/harness -count=1
...
import (
	...
	"github.com/DonaldMurillo/gofastr/framework/experimental/harness/mcpclient"
