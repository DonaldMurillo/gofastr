...
// Property: no credential value in any session state the chat server
...
func TestKilnChatRedEnvelopeMasksCreds(t *testing.T) {
...
// TestKilnChatRedPanelSummaryMasksCreds is the surface extension of
// kiln-envelope-credential-leak onto the PANEL rendering surfaces: the
// chat-bearing GET legs stay pinned by TestKilnChatRedEnvelopeMasksCreds,
...
// extension of kiln-envelope-credential-leak; tests-only; no fix applied).
...
func TestKilnChatRedPanelSummaryMasksCreds(t *testing.T) {
