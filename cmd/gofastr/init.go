...
`, modulePath, name)
		...
		// dsnHasSecret is the same classifier the generate path uses:
		// a credentialed DSN — the postgres placeholder included — has
		// its only home in the 0600, gitignored .env this scaffold
