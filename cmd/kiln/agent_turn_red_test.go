...
// RED TEST — open finding, 2026-09-07 adversarial round 5, phase 2
...
// Property: one agent turn is bounded. An adapter child that forks a
...
func TestKilnAgentTurnRedPipeWedge(t *testing.T) {
