...
- `.claude/skills/app-introspect/SKILL.md` — the eleven introspection
  tools: `app_routes`, `app_plugins`, `app_batteries`, `app_modules`,
  `app_config`, `app_readiness`, `app_goroutine_leaks`, `app_routines`,
  plus `framework_docs_list` / `framework_docs_get` /
  `framework_docs_search` for the embedded framework docs.
