...
const outputFile = new URL("es6-numbers.txt", import.meta.url)
const numLines = 5000
...
for (let i = 0; i < numLines; i++) {
	f64[0] = next()
	out.push(u64[0].toString(16) + "," + f64[0].toString())
}
fs.writeFileSync(outputFile, out.join("\n") + "\n")
console.log(`wrote ${numLines} number vectors to ${outputFile.pathname}`)
