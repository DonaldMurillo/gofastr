...
// CONTRACT-QUESTION red: encoding/json stream semantics allow a second
// Decode; this asserts the package's own strict doctrine (decode_strict:
// refusing ambiguity is the only resolution) extends to exactly-one-value
// bodies; if maintainer prefers stream semantics, document and delete.
//
...
// extension of bind-trailing-json; tests-only; no fix applied).
