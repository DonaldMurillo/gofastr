...
// Pins: query params bound into handler structs carry no raw control
// bytes — the bindPath sanitize rule, applied to the query arrival
// surface (2026-09-06 adversarial pass, round 5).
