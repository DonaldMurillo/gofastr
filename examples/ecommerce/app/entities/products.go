...
func registerProducts(app *framework.App) {
	app.Entity("products", framework.EntityConfig{
		Fields: []schema.Field{
			{Name: "name", Type: schema.String, Required: true, Max: new(float64(200))},
			{Name: "slug", Type: schema.String, Required: true, Unique: true, Pattern: "^[a-z0-9-]+$"},
			{Name: "sku", Type: schema.String, Unique: true, Max: new(float64(50))},
			{Name: "description", Type: schema.Text},
			{Name: "price", Type: schema.Decimal, Required: true, Min: new(float64(0))},
			{Name: "compare_at_price", Type: schema.Decimal, Min: new(float64(0))},
			{Name: "cost", Type: schema.Decimal, Hidden: true, Min: new(float64(0))},
			{Name: "stock", Type: schema.Int, Required: true, Default: 0, Min: new(float64(0))},
			...
			{Name: "weight", Type: schema.Float, Min: new(float64(0))},
