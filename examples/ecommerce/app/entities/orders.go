...
func registerOrders(app *framework.App) {
	app.Entity("orders", framework.EntityConfig{
		Fields: []schema.Field{
			...
			{Name: "customer_name", Type: schema.String, Required: true, Max: new(float64(200))},
			{Name: "customer_email", Type: schema.String, Required: true, Pattern: "^[^@]+@[^@]+\\.[^@]+$"},
			{Name: "customer_phone", Type: schema.String, Max: new(float64(30))},
			{Name: "shipping_address", Type: schema.JSON},
			{Name: "billing_address", Type: schema.JSON},
			{Name: "subtotal", Type: schema.Decimal, Required: true, Min: new(float64(0))},
			{Name: "tax", Type: schema.Decimal, Default: 0, Min: new(float64(0))},
			{Name: "shipping_cost", Type: schema.Decimal, Default: 0, Min: new(float64(0))},
			{Name: "total", Type: schema.Decimal, Required: true, Min: new(float64(0))},
