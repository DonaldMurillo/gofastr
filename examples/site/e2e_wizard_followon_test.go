...
//
// The wizard demo lives at /forms/wizard (wizardDemoPath). Each step
...
// a package var exposed by wizardDemoLast().
...
func TestE2E_Wizard_HappyPath(t *testing.T) {
	...
	err := chromedp.Run(ctx,
		// Navigate to /forms/wizard (site route).
...
// Retargeted to /components/passwordinput (individual site page).
...
// Retargeted to /components/searchinput (individual site page).
