...
// =============================================================================
// battery/print demo (ported from examples/website). Mounts /print/invoice/{id},
// /print/receipt, and a RequireAuth /print/statement/{id} (401 on this no-auth
// demo site). Documents render chrome-free; the battery wraps each in an
// <html>/<head>/@page shell with print CSS and no runtime.js.
// =============================================================================
...
func registerPrintDemos(fwApp *framework.App) {
	...
	_ = pb.RegisterRoutes(fwApp.Router())
}
