...
// Pins: every <form action> sink allow-lists schemes — the noscript
// fallback form's action runs cfg.RPCPath through urlsafe.CleanAnchor
// before interpolation (a rejected value degrades to the inert "#").
// (2026-09-07 adversarial round 5, phase 2; pinned sibling:
// TestFormActionSinksRejectUnsafeURL, framework/ui/ui_link_form_security_test.go.)
