...
func TestLive_IndexRetrievalParaphrase(t *testing.T) {
	...
	docs := []Document{
		...
		{ID: "semantic", Source: "battery/semantic/doc.go",
			Text: "The semantic battery adds local semantic search: vector embeddings, hybrid keyword fusion, MMR diversity, and a Kiln agent context hook."},
	}
