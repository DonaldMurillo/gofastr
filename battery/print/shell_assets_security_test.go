...
// Pins: URL-typed head fields of the print shell (stylesheet href, autoprint
// script src) carry no hostile scheme or protocol-relative host (round 5,
// phase 2). Pinned family: the uihost head-emitter gate
