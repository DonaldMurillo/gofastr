...
// Property: a recovered panic value reaching the default slog sink is
// scrubbed of C0/DEL/C1/bidi — the scrubControlBytes rule pinned for
// RecoveryFn + Timeout's late-panic log (core/middleware) and
// battery/log's SlogErrorReporter.
